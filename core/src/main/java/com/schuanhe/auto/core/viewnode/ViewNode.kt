package com.schuanhe.auto.core.viewnode
...
import com.schuanhe.auto.core.utils.ScreenAdapter
import com.schuanhe.auto.core.utils.ViewChildList
...
class ViewNode : ViewOperation, Comparable<ViewNode> {
    ...
    override fun globalClick(): Boolean {
        ...
        return runBlocking {
            com.schuanhe.auto.core.api.click(relp.x, relp.y)
        }
    }
    ...
    override suspend fun globalLongClick(): Boolean {
        val relp = ScreenAdapter.getRelPoint(getCenterPoint())
        return com.schuanhe.auto.core.api.longClick(relp.x, relp.y)
    }
